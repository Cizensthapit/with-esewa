...
<div class="invoice">
  ...
  if ($result === false) {
    ...
    echo "<table>";
    echo "<tr><th>PN</th><th>Product Image</th><th>Product Name</th><th>Product Price</th><th>Product Quantity</th></tr>";
    $total_quantity = 0;
    $total_price = 0;
    $delivery_fee = 100;
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo "<td><img src='path_to_images/" . $row['product_id'] . ".jpg' alt='Product Image' width='50'></td>";
    ...
    echo "<tr class='total-row'><td colspan='4'>Total Quantity</td><td>$total_quantity</td></tr>";
    echo "<tr class='total-row'><td colspan='4'>Delivery</td><td>NPR$delivery_fee</td></tr>";
    echo "<tr class='total-row'><td colspan='4'>Total Price</td><td>NPR" . ($total_price + $delivery_fee) . "</td></tr>";
    echo "</table>";
  } else {
...
<div class="contact-info">
  ...
  <form action="order.php" method="post">
    ...
    <div class="button-container">
      ...
      <button type="submit" name="order_button" class="order-button">Checkout</button>
    </div>
  </form>
</div>
